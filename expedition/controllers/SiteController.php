...
class SiteController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        return $this->render('index', 
            [
                'kota'=>$kota,
                'markers' => Marker::find()->asArray()->all()
            ]
        );
    }
    ...
    {
        $this->layout = 'blank';
        return $this->render('maps', ['markers' => Marker::find()->asArray()->all()]);
    }
    ...
    public function actionResult() {
        ...
        $dataEkspedisi = Ekspedisi::find()->where(['origin' => (int)$params['origin']])->andWhere(['destination' => (int)$params['destination']])->all();
        $dataMurah = array();
        $dataSedang = array();
        $dataMahal = array();
        $data = array();
        ...
        foreach ($dataEkspedisi as $ekspedisi) {
            ...
            array_push($data, array(
                'ekspedisi' => $ekspedisi->courier,
                'jenis' => $ekspedisi->jenis,
                'tarif' => $ekspedisi->cost,
                'durasi' => $ekspedisi->durasi
            ));
        }
